...
public class StripeUtils {
	...
	public Token retrieveToken(String cardToken)
	...
	public Charge createCharge(Object ammount, Object currency,
			Object cardToken, Object chargeDescription)
			throws AuthenticationException, InvalidRequestException,
			APIConnectionException, CardException, APIException {
		Charge charge = null;
		Stripe.apiKey = API_KEY;
	...
	public Charge retriveCharge(String chargeToken)
			throws AuthenticationException, InvalidRequestException,
			APIConnectionException, CardException, APIException {
	...
	public Refund refund(String chargeToken) throws AuthenticationException,
