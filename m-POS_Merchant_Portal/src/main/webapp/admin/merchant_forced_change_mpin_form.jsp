...
<head>
    ...
    <script type="text/javascript">
        ...
        function doUpdate()
        {
            document.forms[0].action = "forcedchangeMpinAction.do";
            document.forms[0].pageAction.value = "forcedMpin";
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div id="basicform" class="subcontent">
                ...
                <div id="contentwrapper" class="contentwrapper" style="min-height:400px;">
                    ...
                    <form:form method="POST" id="myform" name="myform" commandName="userModel" autocomplete="off" onCopy="return false" onPaste="return false">
                        ...
                        <table border="0" style="margin-left:16%" width="60%">
                            ...
                            <tr>
                                <td class="extra1" width="20%"><spring:message code="merchant.message.old.mpin"/> : <sup
                                ...
                                <td width="20%" align="left"><span id="oldPin_error" class="error_color"></span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="left"><img src="<%=request.getContextPath()%>/resources/images/default/help_img_4.png" class="tooltip" alt="help_img_4.png" title='<%=webAppContext.getMessage("pin.help",null,"default-pin.help",null)%>'/>
                            ...
                            <tr>
                                ...
                                <td align="left"><span id="confirmPin_error" class="error_color"></span>
                                </td>
                            </tr>
                                ...
                                <td align="left" width="20%">
                                    ...
                                    <div class="buttonwrapper">
                                        <a class="btn btn_bulb" href="#"
                                           ...
                                           tabindex="3"><span><spring:message code="merchant.message.change.mpin"/></span></a>
                                    </div>
