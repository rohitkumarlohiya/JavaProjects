...
<body class="withvernav" onload="ischecked();setFocus(document.getElementById('legalBusinessName'));">
...
<div class="pageheader">
    <h1 class="pagetitle"><spring:message code="merchant.message.businessinfo.edit"/>
    </h1>
...
<tr>
    <td class="extra1" colspan="3"><p></p></td>

</tr>

<tr>
    <td class="extra1" width="30%"><spring:message code="merchant.message.merchant.id"/> :
    </td>
    <td class="extra1" width="20%"><form:input path="merchantId" cssClass="field" id="merchantId" maxlength="50"
                                               readonly="true"/>
    </td>
    <td width="50%">
    </td>
...
<tr>
    ...
    <td class="extra1"><form:input path="marketingName" cssClass="field" id="marketingName"
                                   ...
                                   onkeypress="return MyTrapEnter(this,event,'alpha');" tabindex="2" maxlength="50"/>
    </td>
    ...
    <td class="extra1">
        <form:select path="ownershipType" size="1" cssClass="field" id="ownershipType" tabindex="3"
            ...
            <c:forEach items="${businessInfoModel.businessOwnerTypeList}" var="businessOwnerType">
                <form:option
                        value="${businessOwnerType.businessOwnerTypeId}">${businessOwnerType.businessOwnerTypeDescription}</form:option>
            </c:forEach>
        </form:select>
    </td>
...
<tr>
    ...
    <td <%--class="extra1"--%>>
        ...
        <c:forEach items="${businessInfoModel.businessCategoryList}" var="businessCategory">
            <form:option
                    value="${businessCategory.businessCategoryId}">${businessCategory.businessCategoryDescription}</form:option>
        </c:forEach>
...
<tr>
    ...
    <td <%--class="extra1"--%>><form:select path="stateBusinessAddr" cssClass="field" id="stateBusinessAddr"
                                            tabindex="7" onchange="getCityListByStateId();updateFields(this);"
                                            cssStyle="width:93%;">
        <form:option value="-1" label="--- Select ---"/>
    ...
    <td>
        <span class="error_color" id="stateBusinessAddr_error"></span>
    </td>
</tr>
...
<tr>
    <td class="extra1" colspan="2"><form:checkbox path="sameBusinessAddress" id="sameBusinessAddress"
                                                  onclick="copy();"/>
...
<tr id="idtr1" style="display: table-row; ">
    ...
    <td class="extra1"><span class="error_color" id="registeredOfficeAddress_error"></span>
    </td>
</tr>
...
<tr id="idtr2" style="display: table-row; ">
    ...
    <td <%--class="extra1"--%>><form:select path="stateRegisterOfficeAddr" cssClass="field" id="stateRegisterOfficeAddr"
                                            tabindex="12" onchange="getCityListByStateId_Permanent()"
                                            cssStyle="width:93%;">
        <form:option value="-1" label="--- Select ---"/>
        <c:forEach items="${businessInfoModel.stateList}" var="state">
            <form:option value="${state.stateId}">${state.stateDescription}</form:option>
...
<tr id="idtr3" style="display: table-row; ">
    ...
    <td <%--class="extra1"--%>><form:select path="cityRegisterOfficeAddr" cssClass="field" id="cityRegisterOfficeAddr"
        ...
        <form:option value="NONE" label="--- Select ---"/>
        <c:forEach items="${businessInfoModel.cityList2}" var="city">
            <form:option value="${city.cityDescription}">${city.cityDescription}</form:option>
        </c:forEach>
    </form:select></td>
    <td>
...
<tr align="center">
    ...
    <td align="left" width="20%">
        ...
        <div class="buttonwrapper">
            <a class="btn btn_bulb" href="#" onkeypress="return MyTrapEnter(this,event,'');"
               onClick="validateForm();" tabindex="18"><span><spring:message code="common.message.update"/></span></a>
        </div>
    ...
    <%--<tr align="center" >
        ...
        <td align="left" width="20%">
            ...
            <div class="buttonwrapper"><a class="btn btn_rss" href="#" &lt;%&ndash;onClick="doAdd();"&ndash;%&gt; onclick="validateform();"
                                          tabindex="5">
