...
<table width="100%" border="0">
    <tr>
        ...
        <td align="center" style="background-color: #B9C510;color: white;font-weight: bold;font-size: xx-large;"><spring:message code="batch.history.report"/></td>
...
<br>
    ...
    <table width="100%" border="1" >
        <tr>
            ...
            <td width="20%" align="center" style="background-color: #B9C510;color: white;font-weight: bold;"><spring:message code="common.message.batch.num"/></td>
        ...
        <c:forEach var="batch" items="${batchList}">
            <tr >
                <td align="center"  height="10%">${batch.transactionsResponseTs}</td>
                <td align="center" height="10%" >${batch.transactionsBatchNumber}</td>
                <td align="center" height="10%">${batch.transactionsMerchantDeviceNumber}</td>
                <td align="center" height="10%">${batch.transactionsTransTypeCode}</td>
                <td align="right" height="10%">${batch.transactionsValue}</td>
