            ...
            <div id="basicform" class="subcontent">
                ...
                <div id="contentwrapper" class="contentwrapper" style="min-height:400px;">
                    ...
                    <%--  body satrt here --%>
                            ...
                            <br><br><br>
                        <%--Merchant SignUp	Successful.Activation Link has been sent to your email<br>
                        please click on that link to activate your account--%>

                        <%--<a href="merchantLogin.do">Click here to Sign In</a>--%>



                        <table>
                            <tr>
                                 <td align="left"><b>Your registration is nearly complete.All you need to do now is to activate your account</b><br>
