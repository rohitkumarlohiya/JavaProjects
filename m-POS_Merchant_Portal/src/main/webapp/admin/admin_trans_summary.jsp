...
<head>
    ...
    <script type="text/javascript">
        ...
        function validateForm() {
            ...
            var flag;
            var reqType = document.summary.pageAction.value = "report";
            var startdate = document.summary.str_date.value;
            var endDate = document.summary.end_date.value;
            var reportType = document.summary.report_type.value;
            ...
            if (reportType == "1") {
                ...
                myWindow.document.write("<form id='myform' name='myform' action='transSummaryView.do' method='post'>"
            ...
            document.summary.pageAction.value = "report";
            document.summary.method = "post";
            document.summary.action = "transSummaryView.do";
...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle"><spring:message code="report.transaction.summary"/>
            </h1>
        ...
        <div id="contentwrapper" class="contentwrapper" style="min-height:400px;">
            ...
            <div id="basicform" class="subcontent">
                ...
                <form name="summary" id="summary" action="transSummaryView.do" method="post" autocomplete="off"
                    ...
                    <table border="0">
                        ...
                        <%--<tr>
                            ...
                            <td>
                                ...
                                <input type="text" id="str_date" name="str_date" autocomplete="off" tabindex="1">
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align='left' valign='left' class="extra"><spring:message code="common.message.enddate"/>
                                ...
                                :<font color=red>*</font></td>
                            <td>
                                <input type="text" id="end_date" name="end_date" autocomplete="off" tabindex="2">
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="report_type" name="report_type" tabindex="3" >
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="left">
                                <table border="0">
                                    <tr>
                                        <td>
                                            <div class="buttonwrapper" valign="left"><a tabindex="4"
                                                    class="btn btn_orange btn_search radius50" href="#"
                                                    onclick="validateForm();"><span><spring:message
