...
<body class="withvernav" onload="ischecked(); setFocus(document.getElementById('contactName'))">
...
<div class="pageheader">
    <h1 class="pagetitle"><spring:message code="merchant.message.basicprofileinfo.edit"/>
    </h1>
...
<tr>
    <td class="extra1"><spring:message code="merchant.message.residentialaddress"/> : <sup
            style="color:#ff0000; ">*</sup></td>
    <td class="extra1"><form:input path="residentialAddress" cssClass="field" onkeypress="return MyTrapEnter(this,event,'address');"
                                   tabindex="2"

                                   id="residentialAddress"
                                   maxlength='<%=webAppContext.getMessage("adress.line.length.max",null,"default-adress.line.length.max",null)%>'
                                   onkeyup="updateFields(this);"/></td>
    <td>
...
<tr>
    ...
    <td class="extra1"><form:input path="residentialZipCode" cssClass="field"
                                   id="residentialZipCode" onkeypress="return MyTrapEnter(this,event,'numeric');" tabindex="5"
...
<tr>
    ...
    <td><span class="error_color" id="alternateMobileNumber_error"></span>
    </td>
</tr>


<tr>
    <td class="extra1" colspan="2"><form:checkbox path="sameAddressOffnHome"
...
<tr id="idtr1" style="display: table-row; ">
    <td class="extra1"><spring:message code="merchant.message.permanentaddress"/> : <sup
            style="color:#ff0000; ">*</sup></td>
    <td class="extra1"><form:input path="permanentAddress" cssClass="field" onkeypress="return MyTrapEnter(this,event,'address');"
                                   tabindex="8"
                                   id="permanentAddress"
                                   maxlength='<%=webAppContext.getMessage("adress.line.length.max",null,"default-adress.line.length.max",null)%>'/></td>
    <td><span class="error_color" id="permanentAddress_error"></span>
    </td>
</tr>
...
<tr id="idtr3" style="display: table-row; ">
    ...
    <td class="extra1">
        <form:select path="permanentCity" id="permanentCity" size="1" cssClass="field" tabindex="10"
            ...
            <c:forEach items="${userModel.cityList2}" var="city">
                <form:option value="${city.cityDescription}">${city.cityDescription}</form:option>
            </c:forEach>
        </form:select>
    </td>
...
<tr id="idtr4" style="display: table-row; ">
    ...
    <td class="extra1"><form:input path="permanentZipCode" cssClass="field"
                                   id="permanentZipCode" onkeypress="return MyTrapEnter(this,event,'numeric');" tabindex="11"
                                   maxlength='<%=webAppContext.getMessage("zipcode.length.max",null,"default-zipcode.length.max",null)%>'/></td>
    <td><span class="error_color" id="permanentZipCode_error"></span>
    </td>
</tr>
...
<tr align="center">
    ...
    <td align="left" width="20%">
        ...
        <div class="buttonwrapper">
            <a class="btn btn_bulb" href="#" onkeypress="return MyTrapEnter(this,event,'');" tabindex="12"
               onClick="validateForm();"><span><spring:message code="common.message.update"/></span></a>
        </div>
