...
<body class="withvernav"
      onLoad="setFocus(document.getElementById('oldPassword'));document.getElementById('oldPassword').value='';">
            ...
            <div id="basicform" class="subcontent">
                ...
                <div id="contentwrapper" class="contentwrapper" style="min-height:400px;">
                    ...
                    <form:form method="POST" commandName="userModel" name="myForm" id="myForm" autocomplete="off"
                        ...
                        <input type="hidden" name="pageAction" value="passwordpage"/>
                        <table style="margin-left: 5%;margin-top: 5%" width="70%">
                            ...
                            <tr>
                                <td class="extra1" width="15%"><spring:message code="pass.oldpass"/> : <sup
                                        style="color:#ff0000; ">*</sup></td>
                                <td width="20%"><form:password path="oldPassword" cssClass="password" id="oldPassword"
                                                               maxlength='12'
                                                               onkeypress="return MyTrapEnter(this,event,'');" onCopy="return true" onPaste="return true"/>
                                </td>
                                <td width="20%"><span id="oldPassword_error" class="error_color" align="left">
                                        <%-- <%
                                            if (session.getAttribute("wrongpass") != null) {
                                        %>
                                        <%=session.getAttribute("wrongpass"/>
                                        <%}
...
4.Periodically test your current password and change it to a new one."/>
                            ...
                            <tr>
                                ...
                                <td><form:password path="confirmPassword" cssClass="password" id="confirmPassword"
                                                   maxlength='12' onkeypress="return MyTrapEnter(this,event,'');"/>
                                </td>
                                <td><span id="confirmPassword_error" class="error_color"></span>
                                </td>
                            </tr>
                                ...
                                <td align="left" width="20%">
                                    ...
                                    <div class="buttonwrapper">
                                        <a class="btn btn_bulb" href="#"
                                           ...
                                           onkeypress="return MyTrapEnter(this,event,'');"><span><spring:message
                                                code="pass.changepass"/></span></a>
                                    </div>
