...
<body onload="setFocus(document.getElementById('account_name'));" >
...
<div class="pageheader">
    <h1 class="pagetitle"><spring:message code="merchant.message.bank.edit"/>
    </h1>
...
<form:form commandName="bankModel" autocomplete="off" id="myform" name="myform" onCopy="return false" onPaste="return false">
...
<table>
    <tr>
        <td colspan="3">
            ...
            <%
                if (session.getAttribute("edit_bank_err_msg") != null) {
            %>
            <%=session.getAttribute("edit_bank_err_msg")%>
            <%
                }
                session.removeAttribute("edit_bank_err_msg");
    ...
    <tr>
        <td>--%>
            ...
            <table border="0" width="100%">
                ...
                <tr>
                    <td class="extra1" width="30%"><spring:message code="merchant.message.accountname"/> : <sup
                    ...
                    <td class="extra1" width="20%">
                        <form:input path="account_name" cssClass="smallinput" id='account_name' tabindex="1"  title='<%=webAppContext.getMessage("account.name.help",null,"default-account.name.help",null)%>'
                                    cssStyle="" maxlength="50" onkeypress="return MyTrapEnter(this,event,'alpha');" />
                    </td>

                    <td  width="50%"><span id="account_name_err" class="error_color" align="left"></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="20%">
                        <form:select path="account_type" cssClass="field" id="account_type" tabindex="2" >

                            <c:forEach items="${bankModel.accountTypeList}" var="accountType">
                                <form:option
                                        value="${accountType.bankAccountTypeCode}">${accountType.bankAccountTypeName}</form:option>
                            </c:forEach>
                        </form:select>
                    </td>
                    <td width="50%" ><span id="account_type_err" class="error_color" align="left"></span>
                    </td>
                </tr>


                <tr>
                    <td class="extra1" width="30%"><spring:message code="merchant.message.bankname"/> : <sup
                            style="color:#ff0000; ">*</sup>
                    </td>
                    ...
                    <td  width="50%"><span id="bank_name_err" class="error_color" align="left"></span></td>
                </tr>

                <tr>
                    <td class="extra1" width="30%"><spring:message code="merchant.message.branchname"/> : <sup
                            style="color:#ff0000; ">*</sup>
                    </td>

                    <td  class="extra1" width="20%">
                        <form:input path="branch_name" cssClass="smallinput" id='branch_name' tabindex="4"
                                    cssStyle="" maxlength="50"
                                    onkeypress="return MyTrapEnter(this,event,'alpha');"/>
                    </td>

                    <td  width="50%"><span id="branch_name_err" class="error_color" align="left"></span>
                    </td>
                </tr>

                <tr>
                    <td class="extra1" width="30%"><spring:message code="merchant.message.branchcode"/> : <sup
                            style="color:#ff0000; ">*</sup>
                    </td>

                    <td  class="extra1" width="20%">
                        <form:input path="branch_code" cssClass="smallinput" id='branch_code' tabindex="5"
                                    cssStyle="" maxlength='<%=webAppContext.getMessage("branch.code.length",null,"default-branch.code.length",null)%>'
                                    onkeypress="return MyTrapEnter(this,event,'Alphanumeric');"/>
                    </td>

                    <td  width="50%"><span id="branch_code_err" class="error_color" align="left"></span>
                    </td>
                </tr>

                <tr>
                    <td class="extra1" width="30%"><spring:message code="merchant.message.routingnumber"/> : <sup
                            style="color:#ff0000; ">*</sup>
                    </td>

                    <td  class="extra1" width="20%">
                        <form:input path="routing_number" cssClass="smallinput" id='routing_number' tabindex="6"
                                    cssStyle="" maxlength='<%=webAppContext.getMessage("routing.length",null,"default-routing.length",null)%>'
                                    onkeypress="return MyTrapEnter(this,event,'numeric');"/>
                    </td>

                    <td align="left" width="50%"><span id="routing_number_err" class="error_color" align="left"></span>
                    </td>
                </tr>

                <tr>
                    <td class="extra1" width="30%"><spring:message code="merchant.message.accountnumber"/> : <sup
                            style="color:#ff0000; ">*</sup>
                    </td>

                    <td  class="extra1" width="20%">
                        <form:password path="account_num1" cssClass="password" id='account_num1' tabindex="7"
                                       cssStyle="" maxlength='<%=webAppContext.getMessage("account.number.length",null,"default-account.number.length",null)%>'
                                       onkeypress="return MyTrapEnter(this,event,'numeric');" />
                    </td>

                    <td width="50%"><span id="account_num1_err" class="error_color" align="left"></span>
                    </td>
                </tr>

                <tr>
                    <td class="extra1" width="30%"><spring:message code="merchant.message.confirmaccountnumber"/> : <sup
                            style="color:#ff0000; ">*</sup>
                    </td>

                    <td  class="extra1" width="20%">
                        <form:password path="account_num2" cssClass="password" id='account_num2' tabindex="8"
                                       cssStyle="" maxlength='<%=webAppContext.getMessage("account.number.length",null,"default-account.number.length",null)%>'
                                       onkeypress="return MyTrapEnter(this,event,'numeric');"/>
                    </td>

                    <td align="left" width="50%"><span id="account_num2_err" class="error_color" align="left"></span>
                    </td>
                </tr>
                    ...
                    <td align="left" width="20%">
                        ...
                        <div class="buttonwrapper">
                            <a class="btn btn_bulb" href="#"
                               ...
                               tabindex="10"><span><spring:message code="common.message.update"/></span></a>
                        </div>
        ...
        <tr>
            <td>
                ...
                <table border="0" width="100%">
                    ...
                    <tr>
                        <td align="left" width="30%"><spring:message code="merchant.message.accountname"/> : <sup
                                style="color:#ff0000; ">*</sup>
                        </td>
                        ...
                        <td align="left" class="extra" width="20%">
                            <form:input path="account_name" cssClass="smallinput" id='account_name' tabindex="1"
                                        cssStyle="" maxlength="50"
                                        onkeypress="javascript:if(checkforchar(this,event,'name_err')){return trapAdd(event)}else {return false;}"/>
                        </td>
                    ...
                    <tr>
                        <td align="left" width="30%"><spring:message code="merchant.message.accounttype"/>
                            :<sup style="color:#ff0000; ">*</sup>
                        <td width="20%">
                    ...
                    <tr>
                        <td align="left" width="30%"><spring:message code="merchant.message.bankname"/> : <sup
                                style="color:#ff0000; ">*</sup>
                        </td>
                    ...
                    <tr>
                        <td align="left" width="30%"><spring:message code="merchant.message.branchname"/> : <sup
                                style="color:#ff0000; ">*</sup>
                        </td>
                    ...
                    <tr>
                        <td align="left" width="30%"><spring:message code="merchant.message.branchcode"/> : <sup
                                style="color:#ff0000; ">*</sup>
                        </td>
                    ...
                    <tr>
                        <td align="left" width="30%"><spring:message code="merchant.message.routingnumber"/> : <sup
                                style="color:#ff0000; ">*</sup>
                        </td>
                    ...
                    <tr>
                        <td align="left" width="30%"><spring:message code="merchant.message.accountnumber"/> : <sup
                                style="color:#ff0000; ">*</sup>
                        </td>
                    ...
                    <tr>
                        <td align="left" width="30%"><spring:message code="merchant.message.confirmaccountnumber"/> : <sup
                                style="color:#ff0000; ">*</sup>
                        </td>
                    ...
                    <tr align="center">
                        ...
                        <td align="left" width="20%">
                            ...
                            <div class="buttonwrapper">
                                <a class="btn btn_bulb" href="#"
                                   onClick="doSave();" tabindex="3"><span><spring:message code="common.message.update"/></span></a>
                            </div>
