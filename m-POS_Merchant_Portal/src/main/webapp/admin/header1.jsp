...
<%--<script>
    //window.location.href = <%=request.getContextPath()%>+"/Mpos.do";
    window.location.href = <%=session.getServletContext().getContextPath()%>+"/Mpos.do";
</script>--%>
<c:redirect url='Mpos.do'/>
<%
    }
...
<div class="bodywrapper">
    <div class="topheader">
     ...
     <%--   <div class="middle"><img src="images/default/m-pos.png" width="80" height="86" alt="m-pos.png"/>
    </div>--%>

        <div class="middle1" align="center">
            <img src="<%=request.getContextPath()%>/resources/images/default/m-pos.png" width="130" height="30" alt="m-pos.png"  <%--style=" margin-top: 10px;"--%>/>
        </div>
            ...
            <div class="userinfodrop">
                ...
                <div class="userdata">
                    ...
                    <ul>
                        ...
                        <%--<li><a href="changePasswd.do"><%=prop.getProperty("left.ChangePassword")%></a></li>--%>
