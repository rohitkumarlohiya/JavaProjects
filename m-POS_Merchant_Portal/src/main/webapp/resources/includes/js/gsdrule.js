...
function Generic_rule(s,common_chk){
 ...
 // var alphanumeric_chk = common_chk;
  ...
  if (Generic_rule(s,alphanSpecial_chk)){
   ...
   function passwd_length_pinpay(objId,spanid)
   {
   var passwd_length=objId.value.length;
   minLength='6';
   maxLength='10';
...
/*function isSpecialChk(objId,spanid) {
   ...
   function isSpecialChk(objId, helperMsg, spanid) {
...
// NOTE ::  The function which is define GSD Rule return true for error and after message it convert to false.
   ...
   function GSDRule_pinpay(objId,spanid,helperMsg,helperMsg1,helperMsg2,helperMsg3,helperMsg4,helperMsgSpecial,helperMsgNumeric)
   {

   // alert("== GSDRule_pinpay ===");
   // var helperMsg= ;
   var txt = "<span class='error_color'>" + helperMsg + " <br/></span>";
   var s = objId.value;
   var elem = objId;
   ...
   if (isSpecialChk(objId,helperMsg4,spanid)==false){
        // helperMsg4 ="Allowed characters are : A-Z ,a-z ,0-9 ,# ,@ ,$,_"
       objId.style.backgroundColor = errorColor;
       document.getElementById(spanid).innerHTML = helperMsg4;
       return false;
   }



   if (passwd_length_pinpay(objId,spanid)){
       //var helperMsg2="Password should be between 6 to 10 characters.";
       objId.style.backgroundColor = errorColor;
       document.getElementById(spanid).innerHTML = helperMsg2;
       return false;
   }
   ...
   if (Generic_rule(s,alphanumeric_chk)){
      //alert("alphanumeric_chk");
       objId.style.backgroundColor = errorColor;
       //var helperMsgSpecial="The password must contain at least one special character.";
       document.getElementById(spanid).innerHTML = helperMsgSpecial;
       return false;
   }

   if (Generic_rule(s,alphanSpecial_chk)){
       //alert("alphanSpecial_chk");
       objId.style.backgroundColor = errorColor;
       //var helperMsgNumeric="The password must contain at least one number.";
       document.getElementById(spanid).innerHTML = helperMsgNumeric;
       return false;
   }

   if (Generic_rule(s,numericSpecial_chk)){
       //alert("numericSpecial_chk");
       objId.style.backgroundColor = errorColor;
       document.getElementById(spanid).innerHTML = helperMsg;
       return false;
   }
