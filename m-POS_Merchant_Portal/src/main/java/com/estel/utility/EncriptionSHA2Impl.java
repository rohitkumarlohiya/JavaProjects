...
import java.security.NoSuchAlgorithmException;
 ...
 public class EncriptionSHA2Impl {
    ...
    private String ALGORITHM;
      ...
      */
     public EncriptionSHA2Impl(String algorithm) throws NoSuchAlgorithmException
    {
        if (algorithm.toUpperCase().equals("SHA-224"))
        {
            ALGORITHM = algorithm;
     ...
     public byte[] digest(byte[] message)
    {
     ...
     private static byte[] digest224(byte[] message) {
        ...
        for (int i = 0; i < 7; i++)
        {
            System.arraycopy(EncriptionSHA2Impl.intToBytes(H[i]), 0, hashed, 4*i, 4);
        }
     ...
     private static byte[] digest384(byte[] message)
    {
        ...
        for (int i = 0; i < 6; i++)
        {
            System.arraycopy(EncriptionSHA2Impl.longToBytes(H[i]), 0, hashed, 8*i, 8);
        }
    ...
    private static byte[] padMessage2(byte[] data)
    {
     ...
     public static void main(String[] args){
         ...
         try{
             String s = "98990756581234";

        // System.out.println("Input String : "+s);
         //MessageDigest md1 = MessageDigest.getInstance("SHA-256");
         EncriptionSHA2Impl sha2 = new EncriptionSHA2Impl("SHA-256");
            // String expectedString = EncriptionSHA2Impl.bytesToHex(md1.digest(s.getBytes()));
             String actualString = EncriptionSHA2Impl.bytesToHex(sha2.digest(s.getBytes()));

         System.out.println("=========");
         //System.out.println(" expectedString String s=="+expectedString+"getting from sha2 actualString "+actualString);
